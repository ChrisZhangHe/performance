...
declare class ESLintWebpackPlugin {
  ...
  key: string;
  options: import('_eslint-webpack-plugin@3.2.0@eslint-webpack-plugin/types/options').PluginOptions;
  /**
...
type Options = import('_eslint-webpack-plugin@3.2.0@eslint-webpack-plugin/types/options').Options;
